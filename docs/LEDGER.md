...
- Summary: Defines two projection engine modes for CPSC:
  ...
  - Includes reference local rule (PropagationRule) matching cpsc-engine-rtl docs/CPSC-RTL-ARCHITECTURE.md §4.4
